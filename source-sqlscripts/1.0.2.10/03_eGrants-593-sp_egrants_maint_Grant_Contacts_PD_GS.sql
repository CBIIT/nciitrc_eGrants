USE [EIM]
GO
/****** Object:  StoredProcedure [dbo].[sp_egrants_maint_Grant_Contacts_PD_GS]    Script Date: 9/5/2024 9:27:05 AM ******/
SET ANSI_NULLS ON
GO
...
WHERE (SUFFIX_CODE IS NULL OR SUFFIX_CODE LIKE ''%A%'') AND ACTION_TYPE NOT LIKE ''REVISION'' AND CANCEL_REASON_ID IS NULL AND appl_type_code IN (''1'', ''2'', ''4'', ''5'', ''7'', ''9'')  AND DUMMY_ACTION_FLAG <> ''Y'' ')
