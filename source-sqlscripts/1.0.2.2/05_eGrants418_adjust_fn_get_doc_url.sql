...
IF @impac_doc_type in('FSR','AWS','PRM','MYP','CLD','WBR','PRACPC','PRANCE','PRACOV','PRAGEN') SET @doc_url=@s2server_name + dbo.fn_get_env_url('docservice_data_keyid') + CONVERT(varchar,@nga_rpt_seq_num) + '/' + @impac_doc_type
