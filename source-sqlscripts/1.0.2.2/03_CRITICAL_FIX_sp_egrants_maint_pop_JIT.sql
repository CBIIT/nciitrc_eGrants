USE [EIM]
GO
/****** Object:  StoredProcedure [dbo].[sp_egrants_maint_pop_JIT]    Script Date: 12/6/2023 3:49:20 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER   PROCEDURE [dbo].[sp_egrants_maint_pop_JIT]
AS
...
SELECT DISTINCT serial_num,appl_id,doc_type_code,submitted_file_date,doc_version,'https://services.internal.era.nih.gov/docservice/dataservices/document/once/keyId/'+CAST(DOC_KEY_ID as varchar) +'/' + DOC_TYPE_CODE as [url]
