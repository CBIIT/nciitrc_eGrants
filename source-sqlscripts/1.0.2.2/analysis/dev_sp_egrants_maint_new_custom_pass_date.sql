USE [EIM]
GO
/****** Object:  StoredProcedure [dbo].[sp_egrants_maint_custom_pass_date]    Script Date: 12/20/2023 3:16:17 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER      PROCEDURE [dbo].[sp_egrants_maint_custom_pass_date]   @D  		smalldatetime as
...
------------------------------------------------------------
print 'Completed sp_egrants_maint_custom_pass_date'
EXEC [sp_egrants_maint_new_custom_pass_date.sql]
