-- add specific_year_pi_name and specific_year_pi_email_address



--- new udf 1, fn_get_pi_name_by_applid_specific_year ----


USE [EIM]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_get_pi_name_by_applid_specific_year]    Script Date: 3/13/2023 1:25:29 PM ******/
SET ANSI_NULLS OFF
GO
...
--- new udf 2, fn_get_pi_name_by_applid_specific_year  ----



USE [EIM]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_get_pi_name_by_applid_specific_year]    Script Date: 3/13/2023 3:13:50 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
declare @pi_name  varchar(92)
set @pi_name=(
	select pi_name from vw_appls where appl_id=@appl_id
)
...
--- new udf 3, fn_get_project_name_by_applid_specific_year  ----

USE [EIM]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_get_project_name_by_applid_specific_year]    Script Date: 3/14/2023 3:13:50 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
--- new udf 4, fn_get_org_name_by_applid_specific_year  ----

USE [EIM]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_get_org_name_by_applid_specific_year]    Script Date: 3/14/2023 3:13:50 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
--- new udf 5, fn_get_institution2_by_applid_specific_year  ----

USE [EIM]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_get_institution2_by_applid_specific_year]    Script Date: 3/30/2023 10:54:49 AM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
--- new udf 6, fn_get_institution1_by_applid_specific_year  ----

USE [EIM]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_get_institution1_by_applid_specific_year]    Script Date: 3/30/2023 10:54:49 AM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
USE [EIM]
GO
/****** Object:  StoredProcedure [dbo].[sp_web_egrants]    Script Date: 3/30/2023 12:06:00 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER OFF
GO
...
--INNER JOIN appls a on t.grant_id = a.grant_id
