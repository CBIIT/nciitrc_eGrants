$tempScriptDir = "C:\temp"
$tempXml = Join-Path $tempScriptDir "AddSuppProd-Legacy-task.xml"

$taskName = "AddSuppProd-Legacy"
$taskDescription = "Runs AddSuppProd.bat Monday through Friday at minutes 3,18,58 during hours 7 through 19."

$execute = "cmd.exe"
$arguments = '/c "C:\eGrants\apps\AddSuppProd.bat"'
