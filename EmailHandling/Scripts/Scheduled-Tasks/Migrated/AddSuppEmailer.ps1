...
$sourceZip = "C:\temp\AddSuppEmailer.zip"
$destinationRoot = "C:\eGrants\apps"
$destinationZip = Join-Path $destinationRoot "AddSuppEmailer.zip"
$extractTemp = Join-Path $destinationRoot "AddSuppEmailer"
$addSuppEmailerExe = Join-Path $extractTemp "AddSuppEmailer.exe"
$tempScriptDir = "C:\temp"
$tempXml = Join-Path $tempScriptDir "AddSuppEmailer-task.xml"

$taskName = "AddSuppEmailer"
$taskDescription = "Runs AddSuppEmailer.exe Monday through Friday at hours 7-19 on minutes 3,18,58 of every hour."

$execute = "cmd.exe"
$arguments = "/c set DOTNET_ENVIRONMENT=$Environment&& `"C:\eGrants\apps\AddSuppEmailer\AddSuppEmailer.exe`""
$workingDirectory = "C:\eGrants\apps\AddSuppEmailer"
...
try {
    ...
    $exeExists = Test-Path $addSuppEmailerExe
