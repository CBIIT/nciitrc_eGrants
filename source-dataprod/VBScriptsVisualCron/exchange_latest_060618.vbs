...
'wscript.echo "Exchange_latest script is going to run!! "
	...
	conStr = "Provider=SQLOLEDB.1;Password=XXX;Persist Security Info=True;User ID=egrantsuser;Initial Catalog=EIM;Data Source=NCIDB-P391-V.nci.nih.gov\MSSQLEGRANTSP,59000;Application Name=egrants"
