...
CREATE PROCEDURE [dbo].[sp_web_egrants_load_data_autocomplete_to_be_deleted] 
...
IF (@fy is not null and @fy<>'') and (@mechanism is null or @mechanism ='') and (@admincode is null or @admincode='') and (@serialnum is null or @serialnum='')	
BEGIN
...
--IF (@fy is not null and @fy<>'') and (@mechanism is not null and @mechanism<>'') and (@admincode is null or @admincode='') and (@serialnum is null or @serialnum='')	
--BEGIN
--SET @sql ='select distinct top 10   fy, activity_code from vw_grants_construct_fy_Mechanism_Admincode_serialNum where fy like '+ nchar(39)+ convert(varchar, @term) + '%' + nchar(39) +' and activity_code='+char(39)+ @mechanism +char(39)+' order by fy'
-- exec ( @sql)
--END
...
--IF (@fy is not null and @fy<>'') and (@mechanism is null or @mechanism ='') and (@admincode is null or @admincode='') and (@serialnum is not null and @serialnum<>'')	
--BEGIN
--SET @sql ='select distinct top 10  fy,activity_code serial_num from vw_grants_construct_fy_Mechanism_Admincode_serialNum where fy like  '+ nchar(39)+ convert(varchar, @term) + '%' + nchar(39) +' and serial_num=' +convert(varchar, @serialnum) +'  order by fy'
--exec(@sql)
--END
...
--IF (@fy is not null and @fy >0) and (@mechanism is not null and @mechanism<>'') and (@admincode is not null and @admincode<>'') and (@serialnum is null or @serialnum='')	
--BEGIN
--SET @sql ='select distinct top 10  fy, activity_code, admin_phs_org_code from vw_grants_construct_fy_Mechanism_Admincode_serialNum where fy like '+char(39) + convert(varchar, @term) + '%'+ +char(39)+' and activity_code =' +char(39)+ @mechanism +char(39)+' and admin_phs_org_code=' +char(39)+ @admincode +char(39)+' order by fy'
--exec(@sql)
--END
  
-----1-2-4, Autocomplete by @fy, @mechanism and @serialnum
--IF (@fy is not null and @fy >0) and (@mechanism is not null or @mechanism<>'') and (@admincode is  null or @admincode ='') and (@serialnum is not null and @serialnum<>'')	
--BEGIN
--SET @sql ='select distinct top 10  fy, activity_code,serial_num from vw_grants_construct_fy_Mechanism_Admincode_serialNum where fy like ' +char(39)+ convert(varchar, @fy) + '%'+ +char(39)+' and activity_code=' +char(39)+ @mechanism +char(39)+' and serial_num=' +convert(varchar, @serialnum) +' order by fy'
--exec(@sql)
--END


-----1-3-4, Autocomplete by @fy, @admincode and @serialnum
--IF (@fy is not null and @fy >0) and (@mechanism is null or @mechanism='') and (@admincode is not null and @admincode<>'') and (@serialnum is not null and @serialnum<>'')	
--BEGIN
--SET @sql ='select distinct top 10  fy, activity_code,admin_phs_org_code,serial_num from vw_grants_construct_fy_Mechanism_Admincode_serialNum where fy like ' +char(39)+ convert(varchar, @fy) + '%'+ +char(39)+' and admin_phs_org_code=' +char(39)+ @admincode +char(39)+' and serial_num=' +convert(varchar, @serialnum) +' order by fy'
--exec(@sql)
--END
...
IF (@fy is not null and @fy <>'') and (@mechanism is not null and @mechanism<>'') and (@admincode is not null and @admincode<>'') and (@serialnum is not null and @serialnum<>'')	
BEGIN
SET @sql ='select distinct  top 10 fy, activity_code, admin_phs_org_code, serial_num from vw_grants_construct_fy_Mechanism_Admincode_serialNum where fy like ' +char(39)+ convert(varchar, @fy) + '%'+char(39)+' and activity_code =' +char(39)+ @mechanism +char(39)+' and admin_phs_org_code=' +char(39)+ @admincode +char(39)+' and serial_num=' +convert(varchar, @serialnum) +' order by serial_num '
exec(@sql)
END
