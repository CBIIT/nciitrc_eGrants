...
set @s2server_name = 'https://s2s.era.nih.gov/'
set @sql_report_server = 'https://ncidb-q356-v.nci.nih.gov/ReportServer_MSSQLEGRANTSQ/'
END
...
----NEW PRAM
IF @impac_doc_type in('PRM_NEW') SET @doc_url=@s2server_name + 'docservice/dataservices/document/once/keyId/' + CONVERT(varchar,@nga_rpt_seq_num) + '/CORAM'
