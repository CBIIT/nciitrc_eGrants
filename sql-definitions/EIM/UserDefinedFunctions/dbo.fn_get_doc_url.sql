...
*/
set @locall_image_server=dbo.fn_get_env_url('egrants_web_img_nih')+@IC+'.nih.gov/'
set @impac_image_server=dbo.fn_get_env_url('egrants_dev_impac')+@IC+'.nih.gov/'
set @s2server_name = dbo.fn_get_env_url('s2server_era_dev')
set @sql_report_server =dbo.fn_get_env_url('nci_dev_reportserver')
set @era_server =dbo.fn_get_env_url('apps_dev_era')
...
set @impac_image_server='https://i2e-test.'+@IC+'.nih.gov/'
set @s2server_name = 'https://s2s.era.nih.gov/'
set @sql_report_server = 'https://ncidb-q389-v.nci.nih.gov/ReportServer_MSSQLEGRANTSQ/'
set @era_server = 'https://apps.era.nih.gov/'
*/
set @locall_image_server=dbo.fn_get_env_url('egrants_web_img_test')+@IC+'.nih.gov/'
set @impac_image_server=dbo.fn_get_env_url('egrants_test_impac')+@IC+'.nih.gov/'
set @s2server_name =dbo.fn_get_env_url( 's2server_era_test')
set @sql_report_server =dbo.fn_get_env_url( 'nci_test_reportserver')
set @era_server = dbo.fn_get_env_url('apps_test_era')
END
...
set @era_server = 'https://apps.era.nih.gov/'
*/
set @locall_image_server=dbo.fn_get_env_url('egrants_web_img_stg')+@IC+'.nih.gov/'
set @impac_image_server=dbo.fn_get_env_url('egrants_stg_impac')+@IC+'.nih.gov/'
set @s2server_name = dbo.fn_get_env_url('s2server_era_stg')
set @sql_report_server = dbo.fn_get_env_url('nci_stg_reportserver')
set @era_server = dbo.fn_get_env_url('apps_stg_era')
END
...
set @era_server = 'https://apps.era.nih.gov/'
*/
set @locall_image_server=dbo.fn_get_env_url('egrants_image_prod')+@IC+'.nih.gov/'
set @impac_image_server=dbo.fn_get_env_url('egrants_prod_impac')+@IC+'.nih.gov/'
set @s2server_name = dbo.fn_get_env_url('s2server_era_prd')
set @sql_report_server = dbo.fn_get_env_url('nci_prd_reportserver')
set @era_server = dbo.fn_get_env_url( 'apps_prd_era')
END
...
IF @url is not null 
BEGIN
	IF (substring(@url,1,5)='data/') SET @doc_url= @locall_image_server + @url 
	IF (substring(@url,1,5)='/data') SET @doc_url= @locall_image_server + SUBSTRING(@url,2,1000)
