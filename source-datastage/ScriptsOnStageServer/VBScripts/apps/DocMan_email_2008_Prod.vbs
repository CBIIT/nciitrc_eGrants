...
'wscript.echo "DocMan script is going to run!! "
	...
	Dim oConn, oRS, cmd
	''DOCMAN
	''conStr = "Provider=SQLNCLI11;Password=DayofSpr!ng;Persist Security Info=True;User ID=AllWebUSER;Initial Catalog=DOCMAN;Data Source=ncidb-p133-v\egrants_prod,52300;Application Name=docman"
	conStr = "Provider=SQLNCLI11;Password=Jo0ne62017!;Persist Security Info=True;User ID=egrantsuser;Initial Catalog=DOCMAN;Data Source=NCIDB-P232-V.nci.nih.gov\MSSQLEGRANTSP,59000;Application Name=egrants"
...
Sub Process()
	...
	DO WHILE ItemtoProcess > 0		
		...
		End If
			...
			If Err.Number <> 0 Then
			Errmsg1="Error Occured! PROD Docman Script"
			Errmsg2=errorMssg
			...
			Errmsg1="Warning! PROD Docman Script has processed 50 mail Items in one instance"			
