...
'wscript.echo "DocMan script is going to run!! "
	...
	conStr = "Provider=SQLOLEDB.1;Password={PROD_DB_PASSWORD};Persist Security Info=True;User ID=AllWebUSER;Initial Catalog=DOCMAN;Data Source=ncidb-p133-v\egrants_prod,52300;Application Name=docman"
	'conStr = "Provider=SQLOLEDB.1;Password={DB_PASSWORD};Persist Security Info=True;User ID=egrantsuser;Initial Catalog=DOCMAN;Data Source=ncidb-d131-v\egrants_dev,52300;Application Name=docman"
