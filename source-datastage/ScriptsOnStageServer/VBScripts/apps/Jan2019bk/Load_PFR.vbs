...
'************************************************************************
	...
	''conStr = "Provider=SQLNCLI11;Password={PROD_DB_PASSWORD};Persist Security Info1=True;User ID=AllWebUSER;Initial Catalog=EIM;Data Source=ncidb-p133-v\egrants_prod,52300;Application Name=egrants"
	conStr = "Provider=SQLNCLI11;Password={DB_PASSWORD};Persist Security Info=False;User ID=egrantsuser;Initial Catalog=EIM;Data Source=NCIDB-P232-V.nci.nih.gov\MSSQLEGRANTSP,59000;Application Name=egrants"
