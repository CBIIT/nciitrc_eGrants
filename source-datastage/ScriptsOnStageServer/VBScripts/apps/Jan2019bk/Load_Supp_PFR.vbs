...
'************************************************************************
	...
	''''conStr = "Provider=SQLOLEDB.1;Password={PROD_DB_PASSWORD};Persist Security Info=True;User ID=AllWebUSER;Initial Catalog=EIM;Data Source=ncidb-p133-v\egrants_prod,52300;Application Name=docman"
