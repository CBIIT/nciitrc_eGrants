...
dBug="n"
conStr = "Provider=SQLNCLI11;Password={DB_PASSWORD};Persist Security Info=True;User ID=egrantsuser;Initial Catalog=EIM;Data Source=NCIDB-P232-V.nci.nih.gov\MSSQLEGRANTSP,59000;Application Name=egrants"
...
Function emailme(SubjMSG,BodyMSG)
	...
	With Mitem
		.To="omairi@mail.nih.gov;qians@mail.nih.gov;ayehualem.anteneh@nih.gov"			
