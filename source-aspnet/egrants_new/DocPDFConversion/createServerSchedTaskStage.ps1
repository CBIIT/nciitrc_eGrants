...
Write-Host "Setting up scheduled task for Stage ..."

$action = New-ScheduledTaskAction -Execute "powershell.exe" -Argument "-File D:\Content\egrants.nci.nih.gov\DocPDFConversion\serverDocToPdf.ps1"
