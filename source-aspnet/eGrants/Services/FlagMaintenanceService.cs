...
namespace eGrants.Services
{
    public class FlagMaintenanceService : IFlagMaintenanceService
    {
        ...
        public List<FlagTypes> LoadFlagTypes()
        {
            ...
            {
                Log.Error(ex, "LoadFlagTypes: Unexpected error occurred while loading flag types");
                throw;
            }
        }
            ...
            string userid)
        {
            ...
            {
                Log.Error(ex,
                    "LoadFlags: Unexpected error occurred - Act: {Act}, FlagType: {FlagType}, UserId: {UserId}",
                    act, flag_type, userid);
                throw;
            }
        }
            ...
            string userid)
        {
            ...
            {
                Log.Error(ex,
                    "LoadAppls: Unexpected error occurred - Act: {Act}, FlagType: {FlagType}, UserId: {UserId}",
                    act, flag_type, userid);
                throw;
            }
        }
        ...
        public void run_db(string act, string flag_type, string admin_code, int serial_num, string id_string, string ic, string userid)
        {
            ...
            {
                Log.Error(ex,
                    "run_db: Unexpected error occurred - Act: {Act}, FlagType: {FlagType}, UserId: {UserId}",
                    act, flag_type, userid);
                throw;
            }
        }
